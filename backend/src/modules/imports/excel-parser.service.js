...
// Column mapping synonyms to accommodate variations in Tamil Nadu horticulture exports
const COLUMN_SYNONYMS = {
  ...
  mi_reference_no: ["mi_reference_no", "company_ref_no", "firm_reference_no"],
  ...
  farmer_contribution: ["farmer_contribution", "farmer_share", "beneficiary_contribution", "farmer_share_amount"],
  invoice_amount: ["invoice_amount", "total_invoice_amount", "inv_amount", "invoice_value"],
  invoice_date: ["invoice_date", "inv_date", "date_of_invoice"],
  state_restricted_amount: ["state_restricted_amount", "state_restriction_amount", "state_restricted"],
  ...
  first_fund_amount: ["first_fund_amount", "1st_fund_amount", "first_installment_amount"],
  ...
  second_fund_amount: ["second_fund_amount", "2nd_fund_amount", "second_installment_amount"],
  ...
  total_fund_released: ["total_fund_released", "total_released_amount", "fund_released_amount", "total_fund_amount"],
  ae_restricted_amount: ["ae_restricted_amount", "ae_restriction_amount"],
  ...
  no_of_days_pending: ["no_of_days_pending", "days_pending", "pending_days", "no_of_pending_days"],
