...
const envSchema = z.object({
  ...
  DB_POOL_MIN: z.string().default("0").transform((v) => parseInt(v, 10)),
  DB_POOL_ACQUIRE: z.string().default("30000").transform((v) => parseInt(v, 10)),
  DB_POOL_IDLE: z.string().default("5000").transform((v) => parseInt(v, 10)),
  DB_STATEMENT_TIMEOUT: z.string().default("30000").transform((v) => parseInt(v, 10)),
  DB_IDLE_TX_TIMEOUT: z.string().default("30000").transform((v) => parseInt(v, 10)),
